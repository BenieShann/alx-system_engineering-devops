...
* One must be able to draw a diagram covering the web stack you built with the sysadmin/devops track projects
* One must be able to explain what each component is doing
* One must be able to explain system redundancy
